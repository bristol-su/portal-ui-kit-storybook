import VTable from "./../../node_modules/@bristol-su/portal-ui-kit/src/components/VTable";
...
export default {
  ...
  argTypes: {
    ...
    totalCount: {
      description:
        "The total number of items. If given, pagination will not be handled natively",
      control: {
        type: "number",
      },
    },
