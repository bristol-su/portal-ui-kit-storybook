...
export default {
  ...
  argTypes: {
    ...
    buttonText: {
      description:
        "The text to show on the button. You may also use the default slot, which will take precedence",
      control: {
        type: "text",
      },
    },
    busyText: {
      description:
        "The text to show on the button when in a busy state. You may also use the default slot, which will take precedence",
      control: {
        type: "text",
      },
    },
